"""An example heudiconv heuristic file for ASL data."""
...
b0_mag = create_key("sub-{subject}/{session}/fmap/sub-{subject}_{session}_magnitude")
pe_rev = create_key(
...
m0 = create_key("sub-{subject}/{session}/perf/sub-{subject}_{session}_task-rest_m0scan")
